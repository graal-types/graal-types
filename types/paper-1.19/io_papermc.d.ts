...
*/
export class RelativeTeleportFlag extends Enum<RelativeTeleportFlag> {
  /**
   * Represents the player's X coordinate
  */
  static readonly X: RelativeTeleportFlag;
  /**
   * Represents the player's Y coordinate
  */
  static readonly Y: RelativeTeleportFlag;
  /**
   * Represents the player's Z coordinate
  */
  static readonly Z: RelativeTeleportFlag;
  /**
   * Represents the player's yaw
  */
  static readonly YAW: RelativeTeleportFlag;
  /**
   * Represents the player's pitch
  */
  static readonly PITCH: RelativeTeleportFlag;
  static valueOf(name: string): RelativeTeleportFlag;
  static values(): RelativeTeleportFlag[];
}
...
import { LivingEntity, Entity, Player, Tameable, PufferFish, Warden, ElderGuardian } from 'org.bukkit.entity';
/**
