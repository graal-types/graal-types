...
export class PaperServerListPingEvent extends ServerListPingEvent {
  constructor(client: StatusClient, motd: string, shouldSendChatPreviews: boolean, numPlayers: number, maxPlayers: number, version: string, protocolVersion: number, favicon: CachedServerIcon | null);
  constructor(client: StatusClient, motd: Component, shouldSendChatPreviews: boolean, numPlayers: number, maxPlayers: number, version: string, protocolVersion: number, favicon: CachedServerIcon | null);
  /**
